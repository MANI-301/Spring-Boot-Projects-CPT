...
@Service
public class EmployeeService {  // ❌ REMOVED @RequiredArgsConstructor
    ...
    public List<EmployeeResponse> getEmployeesBySalaryGreaterThan(Double salary) {
    ...
    public EmployeeResponse updateEmployeeSalary(Long id, Double salary) {
        int updatedRows = employeeRepository.updateEmployeeSalary(id, salary);
        if (updatedRows == 0) {
